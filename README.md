...
[google-cloud-java/java-gsuite-addons](
https://github.com/googleapis/google-cloud-java/tree/main/java-gsuite-addons).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-gsuite-addons`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-gsuite-addons:2.11.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gsuite-addons" % "2.11.0"
```
