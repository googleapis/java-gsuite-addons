      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            onFileScopeGrantedTrigger_ = input.readMessage(com.google.apps.script.type.docs.DocsExtensionPoint.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.apps.script.type.docs.DocsAddOnManifest) e.getUnfinishedMessage();
      ...
      if (onFileScopeGrantedTriggerBuilder_ == null) {
        if (onFileScopeGrantedTrigger_ != null) {
          onFileScopeGrantedTrigger_ =
            com.google.apps.script.type.docs.DocsExtensionPoint.newBuilder(onFileScopeGrantedTrigger_).mergeFrom(value).buildPartial();
        } else {
          onFileScopeGrantedTrigger_ = value;
        }
        onChanged();
